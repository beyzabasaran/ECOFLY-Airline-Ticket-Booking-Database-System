<%@ Page Title="" Language="C#" MasterPageFile="~/AirlineTicketBookingMaster.Master" AutoEventWireup="true" CodeBehind="BookingReport.aspx.cs" Inherits="AirlineTicketBookingProject.BookingReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top:6%">
              ...
              <div id="ticket" runat="server" visible="false">
                <h1 style="font-weight: bold">Online Airline Flight Booking</h1>
                <br />
                <br />
                ...
                <div class="table-bordered">
                    <table class="table-striped" id="tbtPNR" runat="server" style="width: 100%; color: green; font-size: large">
                        ...
                        <tr>
                            <td style="font-weight: bold">Flight Name</td>
                            <td>
                                <asp:Label ID="lblFlightName" runat="server"></asp:Label></td>
                        </tr>
                    </table>
                </div>
                <br />
                ...
                <p style="text-align: center; font-style: italic; font-size: 10pt">
                    Thank you for booking Ticket with us,have a pleasant flight!
                </p>
            </div>
    </div>
</asp:Content>
