<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="BookingReport.aspx.cs" Inherits="AirlineTicketBookingProject.Admin.BookingReport" %>
    ...
    <div class="container" style="margin-top:6%">
        <asp:GridView ID="gdTicketReport" runat="server" EmptyDataText="No Record Found...." AutoGenerateColumns="False" AllowPaging="true" PageSize="20" CssClass=""
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Flight Name" DataField="FlightName" />
