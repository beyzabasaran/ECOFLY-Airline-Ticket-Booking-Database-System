<%@ Page Title="" Language="C#" MasterPageFile="~/AirlineTicketBookingMaster.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="AirlineTicketBookingProject.Home" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        body {
            ...
            background: -webkit-gradient(radial, center center, 0, center center, 460, from(#2a9df4), to(#2F2727));
            /* Safari 5.1+, Chrome 10+ */
            background: -webkit-radial-gradient(circle, #2a9df4, #2F2727);
            /* Firefox 3.6+ */
            background: -moz-radial-gradient(circle, #2a9df4, #2F2727);
            /* IE 10 */
            background: -ms-radial-gradient(circle, #2a9df4, #2F2727);
            height: 600px;
        }
            ...
            <div class="col-lg-4 col-sm-4 col-md-2 col-sm-offset-2 col-md-offset-2" style="margin-left:30%">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Search For Available Flights</h3>
                    </div>
                    <div class="panel-body">
                        <div id="divMessage" runat="server" />
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <asp:Button ID="btnSearch" runat="server" Text="Search Flights" class="btn btn-info btn-block" OnClick="btnSearch_Click"/>
                                </div>
                            </div>
