<%@ Page Title="" Language="C#" MasterPageFile="~/AirlineTicketBookingMaster.Master" AutoEventWireup="true" CodeBehind="PassengerDetailsInfo.aspx.cs" Inherits="AirlineTicketBookingProject.PassengerDetailsInfo" %>
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlBank" runat="server" class="form-control input-sm floatlabel">
                                ...
                                <asp:ListItem Value="1" Text="State Bank Of Turkey"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Bank"></asp:ListItem>
                                <asp:ListItem Value="3" Text="Halkbank"></asp:ListItem>
                                <asp:ListItem Value="4" Text="Ziraat Bank"></asp:ListItem>
                                <asp:ListItem Value="5" Text="Vakıf Bank"></asp:ListItem>
                            </asp:DropDownList>
