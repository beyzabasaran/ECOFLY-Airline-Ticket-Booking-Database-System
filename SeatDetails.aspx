<%@ Page Title="" Language="C#" MasterPageFile="~/AirlineTicketBookingMaster.Master" AutoEventWireup="true" CodeBehind="SeatDetails.aspx.cs" Inherits="AirlineTicketBookingProject.SeatDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top:8%">
         <div class="panel-heading">
                    <div class="col-lg-8">
                        <h4 style="color: black;">You can choose a seat by clicking on it in the layout below:</h4>
                    </div>
                            ...
                            <tr>
                                ...
                                <td style="margin-left:5%">
                                    <div id="holder" style="border:none;color:white;overflow:auto">
                                        <ul id="place" style="margin-top: 20px; color: red">
                                            
                                        </ul>
                                    </div>
                                </td>
                                <td style="color:black;font-size:large;margin-left: 0px">Rear</td>
                            </tr>
                        </table>
